...
label = Label(image=img,bg='#B3E5FC')
...
t1 = Text(root,width=30,height=10,borderwidth=5,bg='#FFFFFF',fg='#00008B',relief=RIDGE)
t1.place(x=10,y=100)

t2 = Text(root,width=30,height=10,borderwidth=5,bg='#FFFFFF',fg='#006400',relief=RIDGE)
t2.place(x=260,y=100)


button = Button(root,text="Translate",relief=RIDGE,borderwidth=3, bg='#4CAF50', fg='#FFFFFF', font=('verdana',10,'bold'),cursor="hand2",command=translate)
button.place(x=150,y=280)


clear = Button(root,text="Clear",relief=RIDGE,borderwidth=3,bg='#F44336', fg='#FFFFFF',font=('verdana',10,'bold'),cursor="hand2",command=clear)
